      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="bg-surface-container-lowest/90 backdrop-blur-lg border-r border-white/5 w-64 flex-col py-md z-40 hidden md:flex h-full">
          ...
          <div className="flex-1 flex flex-col gap-1 px-2">
            <a href="#" className="text-primary bg-primary/10 border-r-4 border-primary px-4 py-3 flex items-center gap-md rounded-l-md transition-transform active:translate-x-1 duration-150 group">
